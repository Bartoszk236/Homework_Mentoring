...
class WeatherApiClientTest {
    ...
    private static final String CACHE_KEY = CITY + "weatherApi";
    ...
    void getWeatherByCityName_successfulResponse_returnsWeatherDataAndCache() {
        ...
        mockWebServer.enqueue(
                new MockResponse(
                        ...
                        ExternalApiResponses.getJsonResponseWeatherApi())
        );
    ...
    void getWeatherByCityName_halfOpenCircuitBreaker_afterSuccessClosesCircuit() throws InterruptedException {
        ...
        mockWebServer.enqueue(new MockResponse.Builder()
                ...
                .headers(Headers.of(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON_VALUE))
                .body(ExternalApiResponses.getJsonResponseWeatherApi())
                .build());
    ...
    private void checkObjectFields(WeatherData resultWeatherData) {
        ...
        assertEquals(23.1, resultWeatherData.getTemperature());
        assertEquals("Partly Cloudy", resultWeatherData.getDescription());
        assertEquals("WeatherApi", resultWeatherData.getSource());
