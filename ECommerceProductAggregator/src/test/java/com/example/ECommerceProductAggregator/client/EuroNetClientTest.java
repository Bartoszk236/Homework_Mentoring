...
class EuroNetClientTest {
    private static final String BASE_URL = "http://localhost:8080/EuroNet";
    ...
    void setUp() {
        ...
        euroNetClient = new EuroNetClient(restClient);
        productName = "Xbox";
    }
    ...
    void givenValidResponseWhenGetProductThenReturnProduct() {
        ...
        mockServer.expect(requestTo(BASE_URL + "/" + productName))
                ...
                .andRespond(withSuccess(ExternalApiResponses.getValidResponseFromEuroNet(), MediaType.APPLICATION_JSON));

        //when
        List<ExternalApiResponse> result = euroNetClient.getProduct(productName);
    ...
    void givenErrorResponseWhenGetProductThenThrowProductNotFoundException() {
        ...
        //when / then
        assertThatThrownBy(() -> euroNetClient.getProduct(productName))
